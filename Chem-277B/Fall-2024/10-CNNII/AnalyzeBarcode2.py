...
class Analyzer():
    ...
    @lru_cache(maxsize = None)
    def RunCNN(self, Nepochs = 20, learning_rate = 0.01,\
                      decay = 0.001, momentum = 0.9, batch_size = 400):
        ...
        #model.add(Conv2D(24, kernel_size = (4, 10), strides = (2,5),\
        #                     activation = 'tanh', padding = 'valid'))
        #model.add(Conv2D(48, kernel_size = (2, 2), strides = (2,2),\
        #                         activation = 'tanh', padding = 'valid'))
        model.add(Flatten())
